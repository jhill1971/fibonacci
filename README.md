...
The program displays the first two Fibonacci numbers (0 and 1).
A loop runs until the counter exceeds the user-specified number, calculating each new fibonacci number and displaying it. 
